...
function ProductCategory2(props) {
    ...
    const rangeSelector = (event, newValue) => {
        ...
        loadedProducts.map((product)=> {
            ...
            console.log(value[0])
            console.log(value[1])
            if(product.price_low >= value[0]*100 && product.price_low <= value[1]*100){
    ...
    function intersectFor4(a, b, c, d) {
        return a.filter(value => b.includes(value) && c.includes(value) && d.includes(value));
    }
    function intersectFor5(a, b, c, d, e) {
        return a.filter(value => b.includes(value) && c.includes(value) && d.includes(value) && e.includes(value));
    }
    function intersectFor6(a, b, c, d, e, f) {
        return a.filter(value => b.includes(value) && c.includes(value) && d.includes(value) && e.includes(value) && f.includes(value));
    }
    function intersectFor7(a, b, c, d, e, f, g) {
        return a.filter(value => b.includes(value) && c.includes(value) && d.includes(value) && e.includes(value) && f.includes(value) && g.includes(value));
    }
            ...
            for(const key in data){
                ...
                { checkLengths("bg") ? (
                    <ul className="filters__sublist ">
                        ...
                        <l1 className="filter__items"> <input className="checkbox" 
                            value="5G" name="Broadband Generation" type="checkbox"/>5G</l1>
                        <l1 className="filter__items"> <input className="checkbox" 
                            value="4G" name="Broadband Generation" type="checkbox"/>4G</l1>
                    </ul>
                ): (console.log("PAss"))}
    ...
    function checkParentCategories() {
        ...
        var xsd = props.fetchURL.replace("https://www.priceya.pixelgradient.com", "/categories");
        var k = xsd.split("/")
                ...
                <div class="wrapper">
                    <div className="row">
                        <div className="row">
                            ...
                            <Link to={"/"}>
                                <a className="tags__text2">Home / {props.fetchURL.replace("https://www.priceya.pixelgradient.com", "/categories").split("/")[2]} / {props.fetchURL.replace("https://www.priceya.pixelgradient.com", "/categories").split("/")[3]}</a>
                            </Link>
                            </div>
                        </div>
                        <div className="row">
                            <div className="filters__list col-10">
                                <a className="tags__text tags__heading">{props.fetchURL.replace("https://www.priceya.pixelgradient.com", "/categories").split("/")[3]}</a>
                            </div>
                        </div>
                        <div className="row">
                            <div className="filters__list section__description">
                                <a className="tags__text">Upgrade your computers or tablets with our big range online and instore. Our computers and tablets include all the big brands, which means top technology, brilliant designs, and stunning features. If you’re a gamer, a student, or want to upgrade your home office, our computers and tablets are perfect. Find the best range of laptops in Australia online or in store at The Good Guys. You’ll get a good deal on leading computer brands for home or back to school use, including Microsoft, HP, Lenovo, Dell, and Acer.</a>
                            </div>
                        </div>
                        <div className="row">
                        ...
                        <div className="row tags__filters--row">
                            ...
                            <div className="sorting__col col">
                                <DropdownButton className="sorting__dropdown" id="dropdown-basic-button" title={sortType}>
                                    <Dropdown.Item className="sorting__dropdown--item" onClick={() => sortProducts("a-z")}>Sort by A-Z</Dropdown.Item>
                                    <Dropdown.Item className="sorting__dropdown--item" onClick={() => sortProducts("lowtoHigh")} >Price: Low to High</Dropdown.Item>
                                    <Dropdown.Item className="sorting__dropdown--item" onClick={() => sortProducts("hightoLow")}>Price: High to Low</Dropdown.Item>
                                    <Dropdown.Item className="sorting__dropdown--item" onClick={() => sortProducts("Popularity")}>Popularity</Dropdown.Item>
                                </DropdownButton>
                            </div>
                        </div>
                    </div>
                                ...
                                <ul className="filters__list col-2">
                                        <ul className="filters__sublist">
                                            ...
                                            {checkParentCategories().map((cate) => {
                                                return(
                                                    <Link to={"/categories/"+mainCategory+"/"+cate}><l1 className="filter__items" onClick={ () => routeChange("categories/"+mainCategory+"/"+cate)} > <a className="category__PC" 
                                                    value="Upto6" name="Price" type="checkbox"/>{cate.replaceAll("-", " ")}</l1></Link>
                                                )
                                            })}
                                        ...
                                        <ul className="filters__sublist ">
                                            ...
                                            <l1 className="filter__items"> <input className="checkbox" 
                                                value="Upto6" name="Price" type="checkbox"/>Up to $600</l1>
                                            <l1 className="filter__items"> <input className="checkbox" 
                                                value="6to12" name="Price" type="checkbox"/>$600-$1200</l1>
                                            <l1 className="filter__items"> <input className="checkbox" 
                                                value="morethan12" name="Price" type="checkbox"/>More than $1200</l1>
                                            ...
                                            <div>
                                                ...
                                                <div className="row">
                                                    <div className="col">
                                                        <input className="min__max--input" placeholder={value[0]*100} onChange></input>
                                                    </div>
                                                    <div className="col">
                                                        <input className="min__max--input" placeholder={value[1]*100} onChange></input>
                                                    </div>
                                                </div>
                                        ...
                                        { checkLengths("brands") ? (
                                            <FilterSubList heading="Brand" filterList={loadedBrands} count={brandCount} incrementCount={incrementCountBrand}/>
                                        ): (console.log("PAss"))}
                                        { checkLengths("screenTypes") ? (
                                            <FilterSubList heading="Screen Type" filterList={screenType} count={screenTypeCount}  incrementCount={incrementCountBrand}/>
                                        ): (console.log("PAss"))}
                                        { checkLengths("screenSizes") ? (
                                            <FilterSubList heading="Screen Size" filterList={screenSizes} count={screenSizesCount}  incrementCount={incrementCountBrand}/>
                                        ): (console.log("PAss"))}
                                        { checkLengths("resolution") ? (
                                            <FilterSubList heading="Resolution" filterList={resolutions} count={screenTypeCount} incrementCount={incrementCountBrand}/>
                                        ): (console.log("PAss"))}
                                        { checkLengths("os") ? (
                                            <FilterSubList heading="Operating System" filterList={os} count={resolutionsCount} incrementCount={incrementCountBrand}/>
                                        ): (console.log("PAss"))}
                                        { checkLengths("headphoneTypes") ? (
                                            <FilterSubList heading="Headphone Type" filterList={headphoneTypes} count={screenTypeCount} incrementCount={incrementCountBrand}/>
                                        ): (console.log("PAss"))}
                                        { checkLengths("Type") ? (
                                            <FilterSubList heading="Type" filterList={type} count={screenTypeCount} incrementCount={incrementCountBrand}/>
                                        ): (console.log("PAss"))}
                                        { checkLengths("Storage") ? (
                                            <FilterSubList heading="Storage" filterList={storage} count={screenTypeCount} incrementCount={incrementCountBrand}/>
                                        ): (console.log("PAss"))}
                                    ...
                                    <div className="product__category-container justify-content-left row">
                                        {
                                            ...
                                            filteredProducts.slice(0, productCount).map((product)=> {
                                                ...
                                                return <ProductCard productURL={product.url} 
