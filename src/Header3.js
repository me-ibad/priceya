...
function Header3(props) {
    ...
    const blogList = [
        {
          ...
          description: "saLorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, \nwhen an unknown printer took a galley of type and scrambled it to make a type specimen book.Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. \n\n saLorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book",
          authorName: 'John Doe',
          authorAvatar: 'https://st4.depositphotos.com/12982378/22072/i/1600/depositphotos_220729084-stock-photo-smiling-adult-man-crossed-arms.jpg',
          createdAt: 'June 03, 2021',
          cover: 'https://images.unsplash.com/photo-1556656793-08538906a9f8?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80',
        },
        {
          id: 2,
          ...
          authorAvatar: 'https://st4.depositphotos.com/12982378/22072/i/1600/depositphotos_220729084-stock-photo-smiling-adult-man-crossed-arms.jpg',
          createdAt: 'June 03, 2021',
          cover: 'https://images.unsplash.com/photo-1550745165-9bc0b252726f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80',
        },
        {
          id: 3,
    ...
    useEffect(() => {
        if(value.length > 0){
            ...
            fetch('https://comparison-website-cebc6-default-rtdb.firebaseio.com/all_products.json').then(
    ...
    function range(start, end) {
        console.log(Array.apply(start, Array(end - 1))
        .map((element, index) => index + start))
        return Array.apply(start, Array(end - 1))
          .map((element, index) => index + start);
      }
    var counter = 2;
      ...
      if(showModal){
            return(
              <div className="fill__window--navigation"> 
                  {<MenuPopup returnFilterValue={props.returnFilterValue} linkComponent = {props.linkComponent} history={props.history} toggle= {openHeader} changeFilterVariable = {props.changeFilterVariable}/>}
              </div>
            )
      }else{
        return (
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li onClick= {openHeader} class="nav-item dropdown mega-dropdown nav-item dropdown menu__item">
                                <a class="nav-link data-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">CATEGORIES</a>
                            </li>
                            <li class="nav-item dropdown mega-dropdown nav-item dropdown menu__item">
                                <a class="nav-link data-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">BRANDS</a>
                                <ul class="dropdown-menu vertical__scroll" aria-labelledby="dropdownMenuButton">
                            ...
                            <li onClick={() => routeChange("categories/phones/mobile-phones")} class="nav-item dropdown mega-dropdown nav-item dropdown menu__item">
                                <a class="nav-link data-toggle" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">SMART PHONES</a>
                            </li>
                            <li onClick={() => routeChange("categories/computers/laptops")} class="nav-item dropdown mega-dropdown nav-item dropdown menu__item">
                                <a class="nav-link data-toggle" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">LAPTOPS</a>
                            </li>
                            {displaySearch ? (
                            <li class="nav-item search__component">
                                    ...
                                    <div className="row search__results">
                                        {result.map((result, index) => {
                                            return(
                                                <div className="row search__result-item" href="" key={index}>
                                                    <p className="col">
                                                        {result}
                                                    </p>
                                                </div>
