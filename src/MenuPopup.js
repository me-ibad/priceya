...
function MenuPopup(props) {
  ...
  const subCategoryData2 = {
    ...
    'home-automation': ['Smart Speakers', 'Smart Displays', 'Smart Lightings'],
    'remote-controls': [],
            ...
            <ul className='filters__sublist categories__popup--nav'>
              ...
              {Object.keys(x).map((value) => {
                ...
                return (
                  ...
                  >
                    <span className='category__icon'>{j}</span>
                    {value}
                  </a>
                );
              })}
                  ...
                  if (selectedCategory == 'Computers') {
                    if (value == 'Networking') {
                      return (
                        <div className='col-4'>
                          <li
                            onClick={() =>
                              routeChange('/categories/computers/' + value)
                            }
                          >
...

                          {
                            ...
                            networking.map((val) => {
                              ...
                              return (
                                <li
                                  onClick={() =>
                                    routeChange('/categories/computers/' + val)
                                  }
                                >
                                  <Link
                                    to={`/categories/computers/` + value + `/`}
                                  >
                                    <a className='sub__menu-item3'>{val}</a>
                                  </Link>
                                </li>
                              );
                            })
                    ...
                    if (value == 'television') {
                      return (
                        <div className='col-4'>
                          <li
                            onClick={() =>
                              routeChange('/categories/television/tvs')
                            }
                          >
                      ...
                      return (
                        <div className='col-4'>
                          <li
                            onClick={() =>
                              routeChange('/categories/television/' + value)
                            }
                          >
                    ...
                    return (
                      <div className='col-4'>
                        <li
                          onClick={() =>
                            routeChange('categories/cameras/' + value)
                          }
                        >
                          <a className='sub__menu-item2'>
                            {value.replaceAll('-', ' ')}
                    ...
                    return (
                      <div className='col-4'>
                        <li
                          onClick={() =>
                            routeChange(
                              'categories/Washing-machines-and-dryers/' + value
                            )
                          }
                        >
                          <a className='sub__menu-item2'>
                    ...
                    return (
                      <div className='col-4'>
                        <li
                          onClick={() =>
                            routeChange(
                              'categories/Fridges-freezers-and-dishwashers/' +
                                value
                            )
                          }
                        >
                    ...
                    return (
                      <div className='col-4'>
                        <li
                          onClick={() =>
                            routeChange(
                              '/categories/' + y[selectedCategory] + '/' + value
                            )
                          }
                        >
                          <Link
